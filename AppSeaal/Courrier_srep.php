...
<body>
                ...
                $donnee = $req0->fetch();
                $req4 = $db->prepare("SELECT Designation FROM typologie WHERE ID = ? ");
                $req4->execute(array($donnee["IDTypologie"]));
                $donnee4 = $req4->fetch();
                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group validate-input">
                                    ...
                                    <input style="border:none;background-color:transparent;" id="exp" name="exp" value="<?php echo $donnee4["Designation"] ?>" READONLY>
                                    <span id="error_name" class="text-danger"></span>
                                </div>
                                ...
                                <div class="form-group validate-input">
                                    <label for="exp">Date limite de réponse:</label>
                                    <input  id="exp" name="exp" style="border:none;background-color:transparent;" value="<?php $date1 = new DateTime($donnee["DateLimite"]); echo $date1->format('d-m-Y'); ?>" READONLY>
                                    <span id="error_name" class="text-danger"></span>
                                </div>
                                    </br>

                                <a href="reponse.php?idc=<?php echo $_GET["id"] ?>" class="btn btn-primary btn-primary" onclick="window.open(this.href, 'Popup', 'scrollbars=0,resizable=0,height=420,width=400,top=400,left=400'); return false;">Répondre à ce courrier <span class="glyphicon glyphicon-share-alt"></span></a>
                            </div>
                        </div>
                    </div>
                </div>
