<?php
$req2 = $db ->prepare('SELECT ID,DateReponse,IDCourrier,Valide,IDService FROM reponse WHERE IDService=:donn And Valide=0 And DateValidRep IS NULL ORDER BY DateReponse DESC');
