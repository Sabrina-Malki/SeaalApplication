                ...
                <div class="col-md-12 col-sm-12 col-lg-6 col-md-offset-3">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group validate-input">
                                <label for="obj">Envoyé A:</label>
                                <textarea  class="form-control" placeholder="Aucun commentaire " rows="5" readonly><?php for($j = 0; $j < sizeof($temp_s);$j++)
                                    {
                                        echo $temp_s[$j]."/".$temp_d[$j]."\n";
