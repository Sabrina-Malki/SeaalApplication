    ...
    <div class="col-md-12 col-sm-12 col-lg-6 col-md-offset-3">
        <div class="panel panel-primary">
            ...
            <div class="form-group validate-input">
                ...
                <input   style="border:none;background-color:transparent;" "<?php $date3 = new DateTime($donnee["DateReponse"]); echo $date3->format('d-m-Y H:i:s'); ?>" READONLY>
            </div>


            <div class="form-check">
                <form method="post" action = "validRep_post.php">
                    <button  type="submit" class="btn btn-primary"  name="valider" id="valider" value="valider" onclick="valider();">Valider la réponse<span class="glyphicon glyphicon-ok"></span></button>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <a href="refus.php?idr=<?php echo $_GET["id"] ?>" class="btn btn-primary btn-primary" id="refuser" name="refuser" onclick="window.open(this.href, 'Popup', 'scrollbars=0,resizable=0,height=300,width=770,top=400,left=400'); return false;)"><span class="glyphicon glyphicon-remove"></span>Refuser la réponse</a>
                    <input type="hidden" id="id_r" name="id_r" value="<?php echo $_GET["id"] ?>">
